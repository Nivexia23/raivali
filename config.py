...
class NatsSettings(EnvSettings):
    ...
    worker_sync_subject: str = Field(default="raivali.worker_sync", validation_alias="NATS_WORKER_SYNC_SUBJECT")
    node_command_subject: str = Field(default="raivali.node.command", validation_alias="NATS_NODE_COMMAND_SUBJECT")
    node_rpc_subject: str = Field(default="raivali.node.rpc", validation_alias="NATS_NODE_RPC_SUBJECT")
    scheduler_rpc_subject: str = Field(
        default="raivali.scheduler.rpc", validation_alias="NATS_SCHEDULER_RPC_SUBJECT"
    )
    node_log_subject: str = Field(default="raivali.node.logs", validation_alias="NATS_NODE_LOG_SUBJECT")
    ...
    telegram_kv_bucket: str = Field(default="raivali_telegram", validation_alias="NATS_TELEGRAM_KV_BUCKET")
...
class LoggingSettings(EnvSettings):
    ...
    file_path: str = Field(default="raivali.log", validation_alias="LOG_FILE_PATH")
