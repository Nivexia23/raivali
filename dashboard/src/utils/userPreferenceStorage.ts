...
const NUM_USERS_PER_PAGE_LOCAL_STORAGE_KEY = 'raivali-num-users-per-page'
const NUM_ADMINS_PER_PAGE_LOCAL_STORAGE_KEY = 'raivali-num-admins-per-page'
const NUM_ITEMS_PER_PAGE_DEFAULT = 10

const USERS_AUTO_REFRESH_INTERVAL_KEY = 'raivali-users-auto-refresh-interval'
const DEFAULT_USERS_AUTO_REFRESH_INTERVAL_SECONDS = 15
const USERS_SHOW_CREATED_BY_KEY = 'raivali-users-show-created-by'
const DEFAULT_USERS_SHOW_CREATED_BY = true
const USERS_SHOW_SELECTION_CHECKBOX_KEY = 'raivali-users-show-selection-checkbox'
const DEFAULT_USERS_SHOW_SELECTION_CHECKBOX = true
const CHART_VIEW_TYPE_KEY = 'raivali-chart-view-type'

const CORES_LIST_USE_CONFIG_MODAL_KEY = 'raivali-cores-list-use-config-modal'
const DEFAULT_CORES_LIST_USE_CONFIG_MODAL = false

export const DATE_PICKER_PREFERENCE_KEY = 'raivali-date-picker-preference'
...
export const CHART_VIEW_TYPE_CHANGE_EVENT = 'raivali-chart-view-type-change'
